...
def compute_max_workers(
    ...
    Args:
        n_trials: Total number of trials to process.
        file_size_bytes: Approximate size of each trial file in bytes.
        requested_workers: Number of workers requested by user/config.
        memory_fraction: Fraction of available memory to use (default 0.13).
    """
